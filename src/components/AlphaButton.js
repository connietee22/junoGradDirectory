...
const AlphaButton = (props) => {
        ...
        // using 
	const [buttonText, setButtonText] = useState('sort by alphabet >>'); // setting default text for button;
	...
	return (
		<form className="alphaContainer">
			<label
				...
				onClick={!props.isAlpha ? (() => changeText('Sort by date added >>')) : (() => changeText('Sort by alphabet >>'))}
                                htmlFor='alphaButton'
